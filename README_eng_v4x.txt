...
pip install OWSLib
--> Python package for client programming with Open Geospatial Consortium (OGC) web service (hence OWS) interface standards, and their related content models. If get an error in calling the function as "from owslib.wms import WebMapService" try to install previous version like for example this seems to work for Python 2.6:
